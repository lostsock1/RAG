...
- [ ] E4 — reindex CLI (still in scope). Conditional embedder/reranker bake-offs **deferred 2026-06-11 (models frozen per user directive — CPU-only VPS, API generation, no GPU)**.
