...
- [ ] E2 — ADR-0020 + contextual chunk augmentation (breadcrumb + LLM arms via existing seams, bake-off). **Unblocked 2026-06-11**: judge on nDCG/MRR ranking lift vs the new harder baseline (MRR@10 0.834 / nDCG@10 0.875).
